...
- **進度**：platform baseline 與 push／merge 雙層 gate 已完成；Codex rules 以實際 execpolicy 驗為 prompt，完整 suite `PASS=1350 FAIL=0`；`B-20260816-debt-08` 已由 warn-only drift checker 結案。
- **下一步**：建立 Codex 三層 TOML 原子 merge helper，並修正 dotsync 聚合 exit semantics。
