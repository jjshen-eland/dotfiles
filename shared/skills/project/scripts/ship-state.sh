...
PROJECT_SCRIPT_DIR="$(resolve_script_dir)" || PROJECT_SCRIPT_DIR="$(dirname "${BASH_SOURCE[0]}")"
REVIEW_LIB="$PROJECT_SCRIPT_DIR/../../deep-review/scripts/lib/review-subjects.sh"
HAVE_REVIEW_LIB=0
if [ -f "$REVIEW_LIB" ]; then
    # Resolved through the neutral-core symlink above.
